...
Build baseline base image:
    ...
    cd $HOME/git/docker-image-dev/docker-swarm/almalinux-9
...
Build vespanode image on top on baseline base image (assuming that development environment home directory is on named volume volume-vespa-dev-almalinux-9):
