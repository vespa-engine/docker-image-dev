...
DOCKER_IMAGE=$USER-vespanode-baselinebase-almalinux-9
DOCKER_NEW_IMAGE=$USER-vespanode-almalinux-9
case $buildmode in
    baseline) DOCKER_NEW_IMAGE=$USER-vespanode-baseline-almalinux-9 ;;
    fixup) DOCKER_IMAGE=$USER-vespanode-baseline-almalinux-9 ;;
esac

BUILD_CONTAINER_NAME=$USER-build-vespanode-almalinux-9-$$
