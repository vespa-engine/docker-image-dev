...
DOCKER_IMAGE=$USER-vespanode-baselinebase-almalinux-8
DOCKER_NEW_IMAGE=$USER-vespanode-almalinux-8
case $buildmode in
    baseline) DOCKER_NEW_IMAGE=$USER-vespanode-baseline-almalinux-8 ;;
    fixup) DOCKER_IMAGE=$USER-vespanode-baseline-almalinux-8 ;;
esac

BUILD_CONTAINER_NAME=$USER-build-vespanode-almalinux-8-$$
