...
VESPA_SRC_REF="3a28bff8b83cf46d324d24a0e11d6f0b553a4dbe"
...
if [[ $(arch) == x86_64 ]]; then
  ...
  curl -L -o /usr/local/bin/kubectl "https://dl.k8s.io/release/$(curl -L -s https://dl.k8s.io/release/stable.txt)/bin/linux/arm64/kubectl"
fi
